...
const Collection = (props) => {
  ...
  return (
    <CollectionStyles>
      ...
      <input onBlur={updateCollection} onChange={handleChange} name="title" value={props.title} />
      <textarea onBlur={updateCollection} onChange={handleChange} name="description" value={props.description}/>
